...
exports.register = async (req, res) => {
  try {
    const { fullName, email, password, mobile, secondMobile, companyName, address, accountType, gstNumber, gstBusinessName } = req.body;
    ...
    user = new User({ fullName, email, password: hashedPassword, mobile, secondMobile, companyName, address, accountType, gstNumber, gstBusinessName, isVerified: false });
